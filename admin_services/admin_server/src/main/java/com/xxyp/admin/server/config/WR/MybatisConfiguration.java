package com.xxyp.admin.server.config.WR;
...
@EnableTransactionManagement(order = 10)  // 启注解事务管理，等同于xml配置方式的 <tx:annotation-driven />
@MapperScan({ "com.xxyp.admin.server.dao"})
public class MybatisConfiguration {
	...
	public SqlSessionFactory sqlSessionFactorys() throws Exception {
		...
		try {
			...
			sessionFactoryBean.setDataSource(roundRobinDataSouceProxy);
			// 读取配置
			//sessionFactoryBean.setTypeAliasesPackage("com.xxyp.merchants.model");
	 ...
	 * "true"); p.setProperty("reasonable", "true"); p.setProperty("returnPageInfo",
	 * "check"); p.setProperty("params", "count=countSql");
